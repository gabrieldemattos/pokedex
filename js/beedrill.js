...
switch(a){
    case "../img/beedrill.png":
        document.getElementById("paragrafo").innerHTML = "Tem três ferrões venenosos nas patas dianteiras e na cauda. Eles são usados para espetar seu inimigo repetidamente.";
        break;
